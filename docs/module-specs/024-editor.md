...
- **视口**：3D/2D 视口、相机控制、Gizmo、与 Pipeline 的渲染对接、与 RHI 的离屏/窗口 RT。
- **场景树**：层级视图、与 Scene/Entity 对接、选择、拖拽、复制/粘贴。
- **属性面板**：与 Object 反射/属性联动、编辑与撤销。
- **资源编辑**：资源浏览器、与 Resource 对接、预览、导入设置。
