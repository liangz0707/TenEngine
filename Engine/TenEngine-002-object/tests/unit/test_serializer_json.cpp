/**
 * @file test_serializer_json.cpp
 * @brief Unit tests for JSONSerializer.
 */
...
int main() {
    ...
    // Serialize
    ISerializer* serializer = CreateJSONSerializer();
    assert(serializer != nullptr);
    assert(serializer->GetFormat() == SerializationFormat::JSON);
