/**
 * @file test_serializer_xml.cpp
 * @brief Unit tests for XMLSerializer.
 */
...
int main() {
    ...
    // Serialize
    ISerializer* serializer = CreateXMLSerializer();
    assert(serializer != nullptr);
    assert(serializer->GetFormat() == SerializationFormat::XML);
