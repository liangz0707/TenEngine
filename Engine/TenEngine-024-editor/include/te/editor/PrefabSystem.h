...
// Note: PrefabInstance, PrefabOverride, and PrefabData are defined in EditorTypes.h
...
public:
   ...
   */
  virtual std::vector<PrefabOverride> GetOverrides(te::entity::EntityId entityId) const = 0;
