...
/**
 * @brief Common transform for multi-selection.
 */
struct MultiSelectionTransform {
  MixedValue<math::Vec3> position;
  MixedValue<math::Vec3> rotation;
  MixedValue<math::Vec3> scale;
  
  // Pivot options
  enum class PivotMode {
    Center,       ///< Center of all objects
    Individual,   ///< Each object individually
    ActiveObject  ///< Relative to active object
  };
...
public:
   ...
   */
  virtual void SetPivotMode(MultiSelectionTransform::PivotMode mode) = 0;
  
  /**
   * @brief Get pivot mode.
   */
  virtual MultiSelectionTransform::PivotMode GetPivotMode() const = 0;
  
  /**
   * @brief Set transform space.
   */
  virtual void SetTransformSpace(MultiSelectionTransform::TransformSpace space) = 0;
  
  /**
   * @brief Get transform space.
   */
  virtual MultiSelectionTransform::TransformSpace GetTransformSpace() const = 0;
