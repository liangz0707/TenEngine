# Feature Specification: 004-scene minimal

**Feature Branch**: `004-scene-minimal`
**Created**: 2026-01-29
**Status**: Draft
...
- Full module spec: `docs/module-specs/004-scene.md`
- Public API contract: `specs/_contracts/004-scene-public-api.md`
- Slice scope (enumerate):
  1. Scene container
  2. minimal load/save

Implement using only types/APIs from upstream contracts; do not implement out-of-scope. Upstream: `specs/_contracts/001-core-public-api.md`, `specs/_contracts/002-object-public-api.md`.
...
- **FR-005**: System MUST align with `specs/_contracts/004-scene-public-api.md` for the in-scope subset
...
- This module contract (subset): `specs/_contracts/004-scene-public-api.md`
