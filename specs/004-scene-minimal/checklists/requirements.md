# Specification Quality Checklist: 004-scene minimal
...
- [ ] This module contract: `specs/_contracts/004-scene-public-api.md` (subset)
- [ ] Depends: `specs/_contracts/001-core-public-api.md`; `specs/_contracts/002-object-public-api.md`; implementation uses only declared types/APIs
- [ ] Spec references `docs/module-specs/004-scene.md` and contracts; slice scope only
