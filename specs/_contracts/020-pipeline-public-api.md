...
| 2026-02-17 | 新增 RenderPipeline 类：Initialize、Shutdown、SetConfig、SetCollectRenderablesCallback、AddPass、CompileFrameGraph、RenderFrame；新增 PassBuilders：CreateGBufferPass、CreateLightingPass、CreatePostProcessPass、CreatePresentPass；新增 RenderingConfig（ValidationLevel、enableProfiling、frameSlotCount）；新增 FrameStats；019 ExecuteLogicalCommandBufferOnDeviceThread、SubmitLogicalCommandBuffer、PresentSwapChain 已实现 |
