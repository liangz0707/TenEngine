# Feature Specification: 001-core minimal
...
- Full module spec: `docs/module-specs/001-core.md`
- Public API contract: `specs/_contracts/001-core-public-api.md`
- Slice scope (enumerate):
  1. Alloc/Free
  2. Log

Implement using only types/APIs from upstream contracts; do not implement out-of-scope. Upstream: none (root module).
...
- **FR-005**: System MUST align with `specs/_contracts/001-core-public-api.md` for the in-scope subset
...
- This module contract (subset): `specs/_contracts/001-core-public-api.md`
